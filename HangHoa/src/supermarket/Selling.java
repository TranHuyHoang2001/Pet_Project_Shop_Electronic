...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(ProdName, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 182, 230, -1));

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel5.setText("Tên Sản Phẩm");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 181, 140, 22));

        jLabel6.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel6.setText("ID Hoá Đơn");
        ...
        CatCb.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 110, 30));
        ...
        jPanel2.add(ProdQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 214, 230, -1));

        FilterBtn.setBackground(new java.awt.Color(0, 0, 0));
        FilterBtn.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        FilterBtn.setForeground(new java.awt.Color(255, 255, 255));
        FilterBtn.setText("Bộ Lọc");
        ...
        jPanel2.add(ClearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 160, -1));
        ...
        AddBtn.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        AddBtn.setForeground(new java.awt.Color(255, 255, 255));
        AddBtn.setText("Thêm Vào Hoá Đơn");
        AddBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                AddBtnMouseClicked(evt);
            }
        });
        jPanel2.add(AddBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, -1, -1));

        UpdateBtn.setBackground(new java.awt.Color(0, 0, 0));
        UpdateBtn.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        UpdateBtn.setForeground(new java.awt.Color(255, 255, 255));
        UpdateBtn.setText("In Hoá Đơn");
        UpdateBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                UpdateBtnMouseClicked(evt);
            }
        });
        jPanel2.add(UpdateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(748, 635, 170, -1));
        ...
        Grdtotallbl.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        Grdtotallbl.setText("Tổng Tiền");
        jPanel2.add(Grdtotallbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(698, 598, 360, 30));

        RefreshBtn.setBackground(new java.awt.Color(0, 0, 0));
        RefreshBtn.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
   ...
   }catch(Exception e)
   {
    ...
    private void AddBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddBtnMouseClicked
        if (ProdQty.getText().isEmpty() || ProdName.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nhập thêm thông tin");
            ...
            if (i == 1) {
                BillTxt.setText(BillTxt.getText() + "\t==========Hoa Đon===========\n\n" + " So\tSan Pham\t\tGia\tSo Luong\tTong\t\n" + i + "\t" + ProdName.getText() + "\t\t" + Uprice + "\t" + ProdQty.getText() + "\t" + ProdTot + "\t\n");
            } else {
